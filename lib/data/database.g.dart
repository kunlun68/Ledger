...
class $RecurringRulesTable extends RecurringRules
  ...
  @override
  late final GeneratedColumn<int> lastGeneratedYyyymm = GeneratedColumn<int>(
    'last_generated_yyyymm',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('last_generated_yyyymm')) {
      context.handle(
        ...
        lastGeneratedYyyymm.isAcceptableOrUnknown(
          data['last_generated_yyyymm']!,
          _lastGeneratedYyyymmMeta,
        ),
      );
    }
...
class $$RecurringRulesTableFilterComposer
  ...
  ColumnFilters<int> get lastGeneratedYyyymm => $composableBuilder(
    column: $table.lastGeneratedYyyymm,
    builder: (column) => ColumnFilters(column),
  );
...
class $$RecurringRulesTableOrderingComposer
  ...
  ColumnOrderings<int> get lastGeneratedYyyymm => $composableBuilder(
    column: $table.lastGeneratedYyyymm,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$RecurringRulesTableAnnotationComposer
  ...
  GeneratedColumn<int> get lastGeneratedYyyymm => $composableBuilder(
    column: $table.lastGeneratedYyyymm,
    builder: (column) => column,
  );
